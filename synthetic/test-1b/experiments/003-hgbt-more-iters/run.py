...
print("Single change from 002: max_iter 500 → 2000")
...
print(f"002-hgbt     (500 iters):     {hgbt_acc:.4f}")
print(f"003-hgbt     (2000 iters):    {acc_scores.mean():.4f}  (vs 002: {acc_scores.mean()-hgbt_acc:+.4f})")
